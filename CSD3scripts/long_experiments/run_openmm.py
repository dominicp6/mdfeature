...
if plumed:
    ...
    if args.metadynamics_method == 'PCA':
        if args.repeat_number == "1":
            script = plm.PCA1_script
        elif args.repeat_number == "2":
            script = plm.PCA2_script
        elif args.repeat_number == "3":
            script = plm.PCA3_script
        elif args.repeat_number == "4":
            script = plm.PCA4_script
        elif args.repeat_number == "5":
            script = plm.PCA5_script
    elif args.metadynamics_method == 'TICA':
        if args.repeat_number == "1":
            script = plm.TICA1_script
        elif args.repeat_number == "2":
            script = plm.TICA2_script
        elif args.repeat_number == "3":
            script = plm.TICA3_script
        elif args.repeat_number == "4":
            script = plm.TICA4_script
        elif args.repeat_number == "5":
            script = plm.TICA5_script
    elif args.metadynamics_method == 'VAMP':
        if args.repeat_number == "1":
            script = plm.VAMP1_script
        elif args.repeat_number == "2":
            script = plm.VAMP2_script
        elif args.repeat_number == "3":
            script = plm.VAMP3_script
        elif args.repeat_number == "4":
            script = plm.VAMP4_script
        elif args.repeat_number == "5":
            script = plm.VAMP5_script
    elif args.metadynamics_method == 'DMAP':
        if args.repeat_number == "1":
            script = plm.DMAP1_script
        elif args.repeat_number == "2":
            script = plm.DMAP2_script
        elif args.repeat_number == "3":
            script = plm.DMAP3_script
        elif args.repeat_number == "4":
            script = plm.DMAP4_script
        elif args.repeat_number == "5":
            script = plm.DMAP5_script
    elif args.metadynamics_method == "REF":
        script = plm.reference_run_script
    elif args.metadynamics_method == "TICA_REF":
        script = plm.ticametad_script
