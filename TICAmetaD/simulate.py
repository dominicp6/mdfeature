...
def continue_running():
    ...
    system.addForce(PlumedForce(plumed_script))   # only place where PLUMED appears
    print("here")
    ...
    # renames an existing filename where i is the smallest integer that gives a filename that doesn't exist
    backup("state.xml")
